...
import { CotizacionFactory } from "../domain/cotizacionFactory";
...
export class CotizacionRegister extends UseCaseCeate<Cotizacion> {
    ...
    constructor(repository: CotizacionRepository, sucursalRepo: SucursalClienteRepository, clienteRepo: ClienteRepository, serviciosRepo: ServicioRepository) {
        super();
